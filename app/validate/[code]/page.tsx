            ...
            <main className="container mx-auto p-4">
                <div className="bg-white shadow-md rounded-md p-6">
                    ...
                    <div className="flex items-center mb-4">
                        <Input onChange={e => setStudentCode(e.target.value)} value={studentCode} type="text" placeholder="Código de Acesso: XXXXX-XXXXX-XXXXX-XXXXX-XXXXX" className="flex-1 mr-4" />
                        <Button onClick={clickHandler} className="bg-orange-500 text-white">CONFIRMAR CÓDIGO</Button>
                    </div>
                    ...
                    {student ? (
                        <div className="bg-green-100 p-4 rounded">
                            <h3 className="text-lg font-bold mb-2">Código de Acesso Válido</h3>
                            <p>
                                O código de acesso digitado pertence a um aluno válido da UFSCar/DIGRA. Você pode prosseguir com a
                                solicitação de cópia do documento.
                            </p>
                            <div className="mt-4">
                        ...
                        <div className="bg-red-100 p-4 rounded">
                            <h3 className="text-lg font-bold mb-2">Código de Acesso Inválido</h3>
                            <p>
                                O código de acesso digitado não pertence a um aluno válido da UFSCar/DIGRA. Por favor, verifique o código
